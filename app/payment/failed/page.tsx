...
import { XCircle, RefreshCw, LayoutDashboard, AlertCircle, ShoppingBag, Loader2 } from 'lucide-react';
...
function FailedContent() {
  ...
  return (
    <div className="bg-white border border-zinc-200/80 rounded-3xl p-6 sm:p-8 max-w-md w-full text-center shadow-xl space-y-6">
      {/* Failed Icon */}
      <div className="w-16 h-16 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mx-auto border border-red-100 animate-in zoom-in-95 duration-200">
      ...
      <div>
        ...
        <p className="text-xs text-zinc-500 mt-1.5 leading-relaxed">
          আপনার পেমেন্ট সম্পন্ন করা যায়নি। গেটওয়ে থেকে ট্রানজ্যাকশনটি বাতিল বা ব্যর্থ হয়েছে।
        </p>
      </div>
      ...
      <div className="bg-zinc-50 rounded-2xl p-4 text-left text-xs space-y-2.5 border border-zinc-100 font-mono">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="font-bold text-red-600 bg-red-100/70 px-2 py-0.5 rounded-md uppercase text-[11px]">
            {status}
          </span>
        </div>
        ...
        <div className="pt-2 border-t border-zinc-200/60 text-[11px] text-zinc-500 font-sans flex items-start gap-1.5">
          ...
          <span>আপনার অ্যাকাউন্ট থেকে টাকা কেটে নেওয়া হলে পরবর্তী ২৪-৭২ ঘণ্টার মধ্যে রিফান্ড হয়ে যাবে।</span>
        </div>
      </div>
